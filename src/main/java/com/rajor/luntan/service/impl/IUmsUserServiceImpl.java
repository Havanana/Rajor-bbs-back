...
import com.rajor.luntan.common.exception.ApiAsserts;
import com.rajor.luntan.jwt.JwtUtil;
...
import com.rajor.luntan.utils.MD5Utils;
...
public class IUmsUserServiceImpl extends ServiceImpl<UmsUserMapper, UmsUser> implements IUmsUserService {
    ...
    @Override
    public UmsUser getUserById2(String id) {
        return baseMapper.selectOne(new LambdaQueryWrapper<UmsUser>().eq(UmsUser::getId, id));
    }
...
//    }
    ...
    public ProfileVO getUserProfile(String id) {
        ...
        int vliders = bmsFollowMapper.selectCount((new LambdaQueryWrapper<BmsFollow>().eq(BmsFollow::getFollowerId, id)));
        profile.setFollowCount(vliders);
